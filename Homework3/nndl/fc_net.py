...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # ================================================================ #    
    a1, cache_a1 = affine_forward(X,self.params['W1'],self.params['b1'])
    l1out, cache_l1out = relu_forward(a1)
    a2, cache_a2 = affine_forward(l1out, self.params['W2'], self.params['b2'])
    scores = a2
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    dl1out, grads['W2'], grads['b2']= affine_backward(da2, cache_a2)
    grads['W2']+=self.reg*self.params['W2']
    da1 = relu_backward(dl1out, cache_l1out)
    dx, grads['W1'], grads['b1']= affine_backward(da1, cache_a1)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    a_caches=[]
    r_caches=[]
    for i in range(len(self.params)//2): # has one redundant relu, but we don't use it
        ...
        a_in = r_out
    scores=a_out # output of the last affine layer
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    for i in reversed( range(1, len(self.params)//2) ):
        dr_out, grads['W'+str(i+1)], grads['b'+str(i+1)]= \
            affine_backward(da_out, a_caches[i])
            
        grads['W'+str(i+1)]+=self.reg*self.params['W'+str(i+1)]
        da_out = relu_backward(dr_out, r_caches[i-1])
        
    dx, grads['W1'], grads['b1']= affine_backward(da_out, a_caches[0])
    grads['W1']+=self.reg*self.params['W1']
