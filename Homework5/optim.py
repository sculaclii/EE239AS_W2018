...
def sgd_nesterov_momentum(w, dw, config=None):
  ...
  #   as next_w, and store the updated velocity as v.
  # ================================================================ #
  v_new= v*config['momentum'] - config['learning_rate']*dw
  w_new= w + v_new + (v_new-v)*config['momentum']
  v= v_new
  w= w_new
  next_w= w_new
  # ================================================================ #
...
def rmsprop(w, dw, config=None):
  ...
  w-= config['learning_rate']/(np.sqrt(config['a'])+config['epsilon']) * dw
  next_w=w
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def adam(w, dw, config=None):
  ...
  v_cor= 1/(1-config['beta1']**config['t']) * config['v']
  a_cor= 1/(1-config['beta2']**config['t']) * config['a']
  w-= config['learning_rate']/(np.sqrt(a_cor)+config['epsilon'])*v_cor
  next_w = w
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
